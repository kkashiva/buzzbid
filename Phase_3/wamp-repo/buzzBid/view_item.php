...
if ($_SERVER['REQUEST_METHOD'] === 'GET') {
    ...
    $query =
        ...
        coalesce(a.actual_end_time,a.scheduled_end_time) auction_end_time
        FROM Item i
                    ...
                    <form action="item_bid.php" method="post">
                        <?php if (mysqli_num_rows($result) == 0) {
                            ...
                            <div class="form_group">
                                ...
                                <textarea id="description" name="description" rows="4" cols="50" readonly
                            ...
                            <div class="form_group">
                                ...
                                <input type="checkbox" name="returable" <?php echo ($row['returnable'] == 1 ? 'checked' : ''); ?> onclick="return false;">
                            </div>
                            ...
                            <div class="form_group">
                                ...
                                $<input type="text" id="new_bid"></input>
                            </div>
                        <?php } ?>
                        <div class="form_group">
                            ...
                            if ($_SESSION['username'] !== $listedBy) {
                                ?>
                                <input type="button" value="Bid On This Item"
                                    onclick="window.location.href='item_bid.php'" />
                            <?php } ?>
                        </div>
                </div>
            </div>
