...
<body>
                    ...
                    <?php if (mysqli_num_rows($result) == 0) {
                        ...
                        <table id="desc_table">
                            ...
                            <tr>
                                ...
                                <td><input type="text" id="item_desc" name="description"
                            ...
                            <tr>
                                ...
                                <td>
                                    <?php if (!empty($getit_now_price) && $_SESSION['username'] != $listedBy && empty($actual_end_time)) { ?>
                                        <input type="button" id="get_it_now_btn" onclick="getitnow()"
                                            value="Get it Now!"></input>
                                    <?php } ?>
                                </td>
                            </tr>
                            <tr>
                        ...
                        <table id="desc_table">
                            <tr>
                                ...
                                <?php echo $startingBid ?>,<?php echo $maxBid ?>)"></input></td>
                                <td>(minimum bid
                                    <?php
                                    $new_bid_inc = empty($maxBid) ? $startingBid : $maxBid + 1.00;
    ...
    <script>
        ...
        function validateBid(getit_now_price, startingBid, maxBid) {
            ...
            if (isNaN(parseFloat(curBid))) {
                ...
                min_new_bid = isNaN(maxBid) ? startingBid : (maxBid + 1.00);
